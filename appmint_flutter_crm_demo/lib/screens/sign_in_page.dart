...
/// Staff sign-in. Leads, contacts and the phone are staff tools, so
...
class _SignInPageState extends State<SignInPage> {
  ...
  Future<void> _signIn() async {
    ...
    switch (result) {
      case SignedIn():
        break; // the auth stream rebuilds onto the home page
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Leads, contacts and the phone are staff tools. '
