...
| [`appmint_flutter_payments_demo`](appmint_flutter_payments_demo) | Flutter | Tabs and items, cash with change, card with reference, split tenders, refunds, receipts, Terminal token | **Working** |
