...
/// Staff sign-in. Issuing tickets and scanning the door are staff actions, so
...
class _SignInPageState extends State<SignInPage> {
  ...
  Future<void> _signIn() async {
    ...
    switch (result) {
      case SignedIn():
        break; // the auth stream rebuilds onto the events page
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Issuing tickets and working the door are staff actions. '
